...
@synthesize isUploadAlbum = _isUploadAlbum;
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        UIImage* maskImg = [UIImage imageNamed:IPHONE5?@"cutpicmask1136":@"cutpicmask"];
        _maskImgView = [[UIImageView alloc] initWithImage:maskImg];
        _maskImgView.frame = CGRectMake(0, 64, maskImg.size.width, IPHONE5? maskImg.size.height/2:maskImg.size.height);
        [self.view addSubview:_maskImgView];
        [self.view bringSubviewToFront:_maskImgView];
        
        _bottonBar = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_maskImgView.frame), SCREEN_WIDTH, SCREEN_HEIGHT - _maskImgView.frame.size.height)];
        [self.view addSubview:_bottonBar];
        
        UIImageView* imgvBarBg = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"call_record_detail_bottom_background.png"]];
...
//        [btnApply setImage:[UIImage imageNamed:@"cutpicbtn_apply.png"] forState:UIControlStateNormal];
        [btnApply setBackgroundImage:[UIImage imageNamed:@"cutpicbtn_apply.png"] forState:UIControlStateNormal];
        [btnApply setBackgroundImage:[UIImage imageNamed:@"cutpicbtn_apply_clicked.png"] forState:UIControlStateHighlighted];
        ...
        [btnApply setTitleColor:UIColorFromRGB(0x1e9e49) forState:UIControlStateNormal];
        ...
        [btnCancel setTitleColor:UIColorFromRGB(0xf23a4b) forState:UIControlStateNormal];
...
- (void)selectImage{
    ...
    CGSize picSize = self.isUploadAlbum?CGSizeMake(DEF_ALBUMSIZE, DEF_ALBUMSIZE):CGSizeMake(DEF_HDSIZE, DEF_HDSIZE);
        ...
        [UIView animateWithDuration:.2 animations:^{
            ...
            if(finished)
            {
                [UIView animateWithDuration:.5 animations:^{
                    ...
                    //删除4.3兼容性代码，deleted by zhoukai 1011
