...
@interface CameraController:BaseUIImagePickerController<UIImagePickerControllerDelegate>{
    ...
    UIButton* flashButtonAuto;//闪关灯按钮 自动
    UIButton* flashButtonOpen;//闪关灯按钮 打开
    UIButton* flashButtonClose;//闪关灯按钮 关闭
    KFlashType flashType; //闪关灯按钮状态
    UIImageView* flashImage;//闪光灯按钮显示
